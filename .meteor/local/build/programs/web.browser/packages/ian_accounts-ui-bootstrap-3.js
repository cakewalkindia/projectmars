...
Template["_loginButtonsFormField"] = new Template("Template._loginButtonsFormField", (function() {                     // 216
  ...
  return Blaze.If(function() {                                                                                         // 218
    ...
    return [ "\n		", HTML.Comment(" TODO: Implement more input types "), "\n		", Blaze.If(function() {                 // 221
      ...
      return [ "\n		", HTML.INPUT({                                                                                    // 239
        id: function() {                                                                                               // 240
          return [ "login-", Spacebars.mustache(view.lookup("fieldName")) ];                                           // 241
        },                                                                                                             // 242
        type: function() {                                                                                             // 243
          return Spacebars.mustache(view.lookup("inputType"));                                                         // 244
        },                                                                                                             // 245
        placeholder: function() {                                                                                      // 246
          return Spacebars.mustache(view.lookup("fieldLabel"));                                                        // 247
        },                                                                                                             // 248
        "class": "form-control"                                                                                        // 249
      }), "\n		" ];                                                                                                    // 250
    }), "\n	" ];                                                                                                       // 251
  });                                                                                                                  // 252
}));                                                                                                                   // 253
                                                                                                                       // 254
Template.__checkName("_loginButtonsChangePassword");                                                                   // 255
Template["_loginButtonsChangePassword"] = new Template("Template._loginButtonsChangePassword", (function() {           // 256
  var view = this;                                                                                                     // 257
  return [ Spacebars.include(view.lookupTemplate("_loginButtonsMessages")), "\n	", Blaze.Each(function() {             // 258
    return Spacebars.call(view.lookup("fields"));                                                                      // 259
  }, function() {                                                                                                      // 260
    return [ "\n		", Spacebars.include(view.lookupTemplate("_loginButtonsFormField")), "\n	" ];                        // 261
  }), "\n	", HTML.BUTTON({                                                                                             // 262
    "class": "btn btn-block btn-primary",                                                                              // 263
    id: "login-buttons-do-change-password"                                                                             // 264
  }, Blaze.View("lookup:i18n", function() {                                                                            // 265
    return Spacebars.mustache(view.lookup("i18n"), "loginButtonsChangePassword.submit");                               // 266
  })), "\n	", HTML.BUTTON({                                                                                            // 267
    "class": "btn btn-block btn-default",                                                                              // 268
    id: "login-buttons-cancel-change-password"                                                                         // 269
  }, Blaze.View("lookup:i18n", function() {                                                                            // 270
    return Spacebars.mustache(view.lookup("i18n"), "loginButtonsChangePassword.cancel");                               // 271
  })) ];                                                                                                               // 272
}));                                                                                                                   // 273
                                                                                                                       // 274
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
